import { type CircleProperties } from './circle';
 ...
 */
export function circleBoundary(center: Point, radius: number) {
...
export function circleToPoints(circle: CircleProperties, segments: number = 20): PointProperties[] {
