import { type CubicCurveProperties } from './cubic-curve';
import { DirectionEnum, MirrorEnum } from '../geometry.enum';
import { type PointProperties } from '../point/point.interface';
import { mirrorPoint, rotatePoint, transformPoint, translatePoint } from '../point/point.function';
...
export function transformCubicCurve(
	curve: CubicCurveProperties,
	matrix: number[]
): CubicCurveProperties {
	return {
