...
import { distanceBetweenPoints, mirrorPoint, rotatePoint, transformPoint } from './point.function';
import type { PointProperties } from './point.interface';
...
export class Point implements Geometry, PointProperties {
	...
	get boundary(): Boundary {
	  return new Boundary({startPoint: this, endPoint: this});
	}
